...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  {
    id: 'climbing_hours_500',
    category: 'climbing_hours',
    name: 'Wall Master',
    description: 'Log 500 hours of climbing',
    icon: 'clock-star-four-points',
    color: '#E5E4E2', // platinum
    tier: 'platinum',
    requirement: { type: 'count', target: 500, unit: 'hours' },
    order: 4,
  },

  // Sessions Logged Achievements
  {
    id: 'sessions_5',
  ...
  },
  {
    ...
    category: 'connections_made',
    name: 'Social Climber',
    description: 'Connect with 25 climbing partners',
    icon: 'account-supervisor-circle',
    color: '#E5E4E2',
    tier: 'platinum',
    requirement: { type: 'count', target: 25, unit: 'connections' },
    order: 4,
  },

  // App Usage/Login Achievements
  {
    id: 'app_days_7',
    category: 'app_usage',
    name: 'Week Warrior',
  ...
  },
  {
    id: 'app_days_90',
    category: 'app_usage',
    name: 'Committed Climber',
    description: 'Use the app for 90 days',
    icon: 'calendar-star',
    color: '#FFD700',
    tier: 'gold',
    requirement: { type: 'count', target: 90, unit: 'days' },
    order: 3,
  },
  {
    id: 'app_days_365',
    category: 'app_usage',
    name: 'Year-Round Climber',
    description: 'Use the app for a full year',
    icon: 'calendar-heart',
    color: '#E5E4E2',
    tier: 'platinum',
    requirement: { type: 'count', target: 365, unit: 'days' },
    order: 4,
  },
